  ...
  return (
    <div className="flex items-center gap-2">
      <Popover>
        ...
        <PopoverContent className={cn("w-auto p-0 light-theme-popover bg-background text-foreground")} align="end">
      ...
      <Select value={project} onValueChange={setProject}>
        ...
        <SelectContent className="light-theme-popover bg-background text-foreground">
